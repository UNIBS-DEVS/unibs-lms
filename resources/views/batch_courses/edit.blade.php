...
@section('title', 'Edit Batch Courses | Unibs Tools')
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white">
            <h5 class="mb-0 fw-semibold">
                <i class="fa fa-users me-2 text-pramary"></i>
                Edit Courses – {{ $batch->name }}
            </h5>
        </div>

        <div class="card-body">

            <form action="{{ route('batch-courses.update', $batch->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row align-items-center">
                    ...
                    {{-- Available trainers --}}
                    <div class="col-md-5">
                        <label class="fw-semibold mb-2">Available Courses</label>
                    ...
                    {{-- Assigned trainers --}}
                    <div class="col-md-5">
                        <label class="fw-semibold mb-2">Courses in Batch</label>
                        <select id="selected" name="courses[]" class="form-select" size="12" multiple>
