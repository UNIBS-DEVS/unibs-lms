...
@section('title', 'Add Batch TOC | Unibs Tools')
            ...
            <div class="col-xl-10 col-lg-11">
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('batches.toc.store', $batch->id) }}" method="POST" novalidate>
                            @csrf
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="title"
                                            ...
                                            placeholder="Enter Topic Title" value="{{ old('title') }}" required>
                                        @error('title')
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" name="plan_start_date"
                                            ...
                                            value="{{ old('plan_start_date') }}" required>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" name="plan_end_date"
                                            ...
                                            value="{{ old('plan_end_date') }}" required>
                                        @error('plan_end_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea name="remark_admin" rows="3" class="form-control @error('remark_admin') is-invalid @enderror"
                                            placeholder="Enter remarks (optional)">{{ old('remark_admin') }}</textarea>
                                        @error('remark_admin')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
