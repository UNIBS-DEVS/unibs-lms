...
@section('title', 'Update Course | Unibs Tools')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="study_material_path"
                                            ...
                                            placeholder="Study Material Path"
                                            value="{{ old('study_material_path', $course->study_material_path) }}">
                                        ...
                                        <div class="flex-grow-1">
                                            <select name="category"
                                                ...
                                                @foreach (['technical', 'managerial', 'functional', 'soft skill', 'others'] as $category)
                                                    <option value="{{ $category }}" @selected(old('category', $course->category) === $category)>
                                                        {{ ucfirst($category) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="status" class="form-select @error('status') is-invalid @enderror">
                                            ...
                                            @foreach (['active', 'inactive'] as $status)
                                                <option value="{{ $status }}" @selected(old('status', $course->status) === $status)>
                                                    {{ ucfirst($status) }}
                                                </option>
                                            @endforeach
                                        </select>
