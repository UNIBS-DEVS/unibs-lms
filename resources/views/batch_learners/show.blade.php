...
@section('content')
    ...
    <div class="container-fluid mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h3 class="mb-0">Batch Learners</h3>

            <div>
                <a href="{{ route('batch-learners.edit', $batch->id) }}" class="btn btn-warning btn-sm">
                    <i class="fa fa-users"></i> Edit Learners
                </a>

                <a href="{{ route('batch-learners.index') }}" class="btn btn-secondary btn-sm ms-1">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-3 fw-semibold">Total Learners</div>
                    <div class="col-md-9">
                        <span class="badge bg-info">{{ $batch->learners_count }}</span>
                    </div>
                </div>
            ...
            <div class="card-body p-0">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover align-middle mb-0">
                        ...
                        <tbody>
                            @forelse ($batch->learners as $index => $learner)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $learner->name }}</td>
                                    <td>{{ $learner->email }}</td>
